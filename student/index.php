                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                                ...
                                                <td> <a href="view/index.php?id=<?php echo $row['rollnumber']; ?>" class="btn btn-info" type="view" name="view" id="view"><i class="fa-solid fa-eye"></i></a> </td>
                                                <td> <a href="edit/index.php?id=<?php echo $row['rollnumber']; ?>" class="btn btn-primary" type="edit" name="edit" id="edit"><i class="fa-solid fa-pen"></i></a> </td>
                                                <td> <a onclick="return confirm('Are you sure to delete this?')" href=" delete/index.php?id=<?php echo $row['rollnumber']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a> </td>
                                </tr>
                        <?php }
                                        } else {
